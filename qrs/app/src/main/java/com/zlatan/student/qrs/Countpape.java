...
public class Countpape extends AppCompatActivity {
    ...
    String dim[]={"20-11-2015 09:00:00","20-11-2015 09:35:00","20-11-2015 10:10:00","20-11-2015 10:45:00","20-11-2015 12:30:00","20-11-2015 13:05:00","20-11-2015 13:40:00","20-11-2015 14:10:00" };
    //GR10&9&7
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_countpape);
        annap=(TextView)findViewById(R.id.tvtv);
        tv=(TextView)findViewById(R.id.textView1);
        tv2=(TextView)findViewById(R.id.textView2);
        tv3=(TextView)findViewById(R.id.textView3);
        tv4=(TextView)findViewById(R.id.textView4);
        tv5=(TextView)findViewById(R.id.tv69);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    d1 = format.parse(dim[0]);
                    d2 = format.parse(dim[1]);
                    d3 = format.parse(dim[2]);
                    d4 = format.parse(dim[3]);
                    d5 = format.parse(dim[4]);
                    d6 = format.parse(dim[5]);
                    d7 = format.parse(dim[6]);
                    d8 = format.parse(dim[7]);
                    dsto=d1;
