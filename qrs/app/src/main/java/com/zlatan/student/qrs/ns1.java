...
public class ns1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Names[] = {
                "Krithika, Mihika", "Anshika, Aditi", "Aayusshmaan, Roslyn, Pujitha, Saransh", "Mishika, Agastya, Ishaan, Sanvi", "Darsh, Nithya, Nysa, Mukund", "Meghna, Lohitaksh, Nainika, Aayush", "Pravvrath, Abheeshta, Shaurya, Nithila", "Tejas, Adya, Shruthi, Suhani", "Bhromor, Bhavin, Jiya, Tejas", "Vaibhav, Aditi, Tara, Ishanth", "Aadhya, Madhav, Shrijani, Aadit", "Vihaan, Anika, Nila, Avdhoot", "Rishi, Vibha, Anushka, Ishanvi","Ishaan, Arnav, Ishana, Akshith","Niharika, Tanmay, Akshara, Jeet","Arjun C, Samridhi, Johan, Prarthana, Mukul, Kaavyaa, Aahana R, Aadya, Puri Jagannath, Vishakha, Hamshini, Mihika, Gokul, Jasnavi, Riya, Sarvesh, Arjun P, Sharath, Amogh, Dhriti, Kyra, Rohith, Abhinav, Ansh, Samrath, Tanvi, Manasvi, Shravan, Vedanth, Manasvi, Tanvi, Johan", "Ayush, Kritin, Arjun, Vishnu ", "Shreyas, Dheeyanksha, Vidyuth, Ananya Srinivasan, Krish, Aahana U, Meghna, Pranav, Anjali, Mahima, Ananya Srisailam, Yash, Pallavi, Srimathi, Ethan, Anika, Manya, Shresta, Nandita, Sharan, Uthkarsh, Ananya K, Shlok, Sakshi, Sidharth, Chandana, \n" +
                ...
                //grade7
                "Anahat, Aryan, Ishaan, Pradyut, Inika, KanishQ, Neha, Kyra, Anand S, Hiya, Minhal, Manogna ", "Sanjana GR, Tarunya","Sai Vaidyaa, Vikas K, Keerthana G", "Antara V, Riya A", "Dhruv Bhatia, Param L, Sudhanva K","Malavika M, Nisha J","Ananya M, Nina H","Rahul M, Shreyas G","Varun I, Chaitanya G","Neha S, Kritika R, Meghna M","Disha P, Nithya A, Madhura S","Shivanshi D, Richelle A, Rohini S", "Suvvan N, Abhiram S", "Aryan S Dhruv A","Aditya S, Pavvan P, Vivek V","Ananya S, Esha S","Shreya J, Stuti G, Anoushka V","Varun H, Rohan T, Mohnish","Mrigank, Jairaj Arnav O","Akshit P, Aldrich","Sanjana Giridhar, Ridhima B","Saathivik S, Tanmay V","Ojaswi B, Adeeba M","Anupam D, Suyash, Rahul M","Prithvi , Akash","Mahit, Mehul ,Sayee Charan","Aditi I, Mihika S, Tiana D","Maya ","Akash Singh, Nitish R, Rahul HR","Aryaman, Rohit V","Benther, Raj deep","Peri, Sahiti","Prisha, Rachna","Mihika , Nitish, Rachana, Rahul M, Aryaman, Sai Charan, Stuti, Adeeba, Perie, Anoushka, Riya, Tiana, Nina, Benther, Neha S, Ananya, Saranghi",
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View view, int pos,
                ...
                Intent intent = new Intent(ns1.this, SBN.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ns1, menu);
        return true;
    }
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
        if (id == R.id.Home) {
            Intent mainIntent = new Intent(ns1.this,Home.class);
            ns1.this.startActivity(mainIntent);
            ns1.this.finish();  // Handle the camera action
        }
        else if (id == R.id.Map_View) {
            Intent mainIntent = new Intent(ns1.this,MapView.class);
            ns1.this.startActivity(mainIntent);
            ns1.this.finish();
        }
            ...
            Intent mainIntent = new Intent(ns1.this,ns1.class);
            ns1.this.startActivity(mainIntent);
            ns1.this.finish();
        }
        else if (id == R.id.About) {
            Intent mainIntent = new Intent(ns1.this,AboutApp.class);
            ns1.this.startActivity(mainIntent);
            ns1.this.finish();

        }
        else if (id == R.id.ss) {
            Intent mainIntent = new Intent(ns1.this,Countanna.class);
            ns1.this.startActivity(mainIntent);
            ns1.this.finish();
